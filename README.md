...
### Movement Quality Analysis Framework
- **Description:** End-to-end pipeline for evaluating movement quality using pose estimation and time-series modeling.  
- **Tech Stack:** Python, PyTorch, OpenCV, NumPy, Pandas  
- **Problem Solved:** Provides objective, data-driven assessment of movement patterns for recognition, classification, and quality scoring.

### Pose-Based Activity Recognition
- **Description:** Machine learning system for recognizing and classifying human activities from pose estimation data.  
- **Tech Stack:** Python, scikit-learn, TensorFlow, OpenPose  
- **Problem Solved:** Transforms raw pose sequences into reliable activity predictions across varied motion types.

### Open-Source React Visualization Tools
- **Description:** Contributions to open-source React projects focused on data visualization and UI development.  
