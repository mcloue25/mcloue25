# About Me:
I’m currently completing a Master’s degree in Advanced Artificial Intelligence, with a strong focus on machine learning, computer vision, and time series modeling. I have over five years of experience building and evaluating ML pipelines using pose estimation data for human movement recognition and quality analysis. Alongside my research work, I’ve developed several open-source React projects and enjoy developing end-to-end systems that bridge research, data, and production.
...
# GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=mcloue25&theme=tokyonight&hide_border=false&include_all_commits=true&count_private=false)<br/>
![](https://nirzak-streak-stats.vercel.app/?user=mcloue25&theme=tokyonight&hide_border=false)<br/>
...
- **Tech Stack:** Python, PyTorch, NumPy, Pandas, scikit-learn, yFinance, XGBoost, LGBM, Pennylane
- **Problem Solved:** Comparative analysis of classical and quantum machine learning model architectures applied to financial data

### Pose Based Tennis swing Classification using 
- **Description:** Developed models capable of classifying tennis swing videos using generated pose features
- **Tech Stack:**  Python, OpenCV, PyTorch, CUDA, MediaPipe, Seaborn, NumPy, Pandas
- **Problem Solved:** Classified Tennis swings with 96% accuracy
